...
<section id="center">
  ...
  <button id="beep" type="button" class="counter">点一下响一声</button>
  <p id="audio-state"></p>
</section>
...
`,r(document.querySelector(`#counter`)),i(document.querySelector(`#beep`),document.querySelector(`#audio-state`));
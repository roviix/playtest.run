...
pub const ADJECTIVES: &[&str] = &[
    "brisk", "calm", "bold", "keen", "swift", "quiet", "warm", "cool", "bright", "gentle", "lucky",
    "merry", "nimble", "plucky", "rapid", "sunny", "tidy", "vivid", "witty", "zesty", "amber",
    "azure", "coral", "cyan", "golden", "indigo", "ivory", "jade", "lilac", "maroon", "olive",
    "pearl", "ruby", "sage", "scarlet", "silver", "teal", "violet", "crimson", "cobalt", "early",
    "eager", "fair", "fresh", "glad", "happy", "jolly", "kind", "lively", "mellow", "noble",
    "proud", "quick", "ready", "steady", "sturdy", "tender", "upbeat", "wise", "young", "misty",
    "windy", "snowy", "rainy",
];

pub const ANIMALS: &[&str] = &[
    "otter", "panda", "koala", "lemur", "gecko", "heron", "finch", "robin", "raven", "swan",
    "tiger", "lynx", "puma", "wolf", "fox", "hare", "deer", "moose", "bison", "yak", "whale",
    "dolphin", "seal", "walrus", "manta", "coral", "squid", "crab", "shrimp", "trout", "salmon",
    "tuna", "carp", "eel", "newt", "frog", "toad", "turtle", "iguana", "cobra", "eagle", "falcon",
    "hawk", "owl", "crane", "stork", "pelican", "puffin", "parrot", "macaw", "badger", "beaver",
    "marten", "ferret", "mink", "ermine", "sable", "stoat", "vole", "shrew", "camel", "llama",
    "alpaca", "zebra",
];

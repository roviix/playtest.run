...
pub fn app(state: AppState) -> Router {
    let router = Router::new()
        ...
        .route(paths::LOGIN_DEVICE_START, post(crate::device::start))
        .route(paths::LOGIN_DEVICE_POLL, post(crate::device::poll))
        ...
        .route(follow_paths::PREVIEW, post(follow::preview))
